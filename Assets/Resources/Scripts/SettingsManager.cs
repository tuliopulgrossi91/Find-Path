...
public class SettingsManager : MonoBehaviour
{
    ...
    private int random_Sfx, r, t; // random sfx (audio), random BG, random texture BG
    private Renderer rd_BG; // renderer BG
    private readonly Texture2D[] tx_BG = new Texture2D[2]; // texture BG
